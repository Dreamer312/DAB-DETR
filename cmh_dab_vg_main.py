...
from cmh_dab_vg_engine import evaluate, train_one_epoch
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('DAB-DETR training and evaluation on SGG script', parents=[get_args_parser()])
